...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('El carrito ha sido actualizado');</script>";
		}
	}
...
header('location:metodopago.php');
	...
	if(isset($_POST['update']))
	{
		...
		$bstate=$_POST['canton'];
		$bcity=$_POST['provincia'];
		$bpincode=$_POST['codigopostal'];
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
echo "<script>alert('Direccion de factura actualizada');</script>";
		}
	}
	...
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Direccion de envio actualizada');</script>";
		}
	}
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a href="index.php" class="btn btn-upper btn-primary outer-left-xs">Continar comprando</a>
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="detallesproducto.php?pid=<?php echo htmlentities($pd=$row['id']);?>" ><?php echo $row['productName'];
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Direccion de factura<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Canton ">Canton  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="canton" name="canton" value="<?php echo $row['billingState'];?>" required>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Provincia">Provincia <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="provincia" name="provincia" required="required" value="<?php echo $row['provincia'];?>" >
					  </div>
 <div class="form-group">
					    <label class="info-title" for="Codigo Postal">Codigo Postal <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="codigopostal" name="codigopostal" required="required" value="<?php echo $row['billingPincode'];?>" >
					  </div>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Direccion de factura</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Canton ">Canton  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="canton" name="canton" value="<?php echo $row['shippingState'];?>" required>
					  </div>
					  <div class="form-group">
					    <label class="info-title" for="Provincia">Provincia <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="provincia" name="provincia" required="required" value="<?php echo $row['shippingCity'];?>" >
					  </div>
 <div class="form-group">
					    <label class="info-title" for="Codigo Postal">Codigo Postal <span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" id="codigopostal" name="codigopostal" required="required" value="<?php echo $row['shippingPincode'];?>" >
					  </div>
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">Finalizar compra</button>

...
?>
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="detallesproducto.php?pid=<?php echo $row['opid'];?>">
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('rastreo.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Rastrear</td>
				</tr>
<?php $cnt=$cnt+1;} ?>

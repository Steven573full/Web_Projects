...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Cargo por envio: </span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="detallesproducto.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Agregar al carrito</a>
													<?php } else {?>

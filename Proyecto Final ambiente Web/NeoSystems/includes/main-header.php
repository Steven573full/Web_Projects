...
<div class="col-xs-12 col-sm-12 col-md-6 top-holder">
...
if(!empty($_SESSION['cart'])){
	...
	?>
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="detallesproducto.php?pid=<?php echo $row['id'];?>"><img  src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" width="35" height="50" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
							
							<h3 class="name"><a href="detallesproducto.php?pid=<?php echo $row['id'];?>"><?php echo $row['productName']; ?></a></h3>
			...
			<div class="clearfix cart-total">
				...
				<a href="micarrito.php" class="btn btn-upper btn-primary btn-block m-t-20">Mi carrito</a>	
			</div>

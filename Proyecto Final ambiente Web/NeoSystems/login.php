...
if($query)
{
	echo "<script>alert('Se ha registrado, bienvenido!');</script>";
}
else{
...
<html lang="en">
	<head>
	    ...
	    <title>NeoSystems| Iniciar Sesion | Registro</title>
...
{
alert("Asegurarse que la contraseña y confirmacion sean iguales");
...
?>
		...
		<div class="radio outer-xs">
		  	<a href="olvide-password.php" class="forgot-password pull-right">Olvide mi contraseña</a>
		</div>
